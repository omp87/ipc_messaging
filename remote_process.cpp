...
int main()
{
    ...
    uint8_t* tmp_malloc = (uint8_t*)malloc(message_ctl_host_remote.data_message_size);
    ...
    memcpy((uint8_t*) &(in_image->data[0]), image_buffer, message_ctl_host_remote.data_message_size);
